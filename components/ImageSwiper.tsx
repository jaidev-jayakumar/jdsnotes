  ...
  return (
    <section
      ...
      style={{
        ...
        ['--card-perspective' as string]: '700px',
        ['--card-z-offset' as string]: '12px',
        ['--card-y-offset' as string]: '7px',
        ['--card-max-z-index' as string]: imageList.length.toString(),
        ['--card-swap-duration' as string]: '0.3s',
    ...
    >
      {cardOrder.map((originalIndex, displayIndex) => (
        <article
          ...
          style={{
            ['--i' as string]: (displayIndex + 1).toString(),
        ...
        >
          <IPhoneFrame width={cardWidth} height={cardHeight}>
            <img
